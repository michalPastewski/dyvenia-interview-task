...
export default function Chatbot() {
  ...
  return (
    <aside className="flex flex-col border-r border-gray-200 w-80 bg-gray-50">
      <div className='py-1 pl-4 font-semibold text-left border-b border-gray-300 '>AI Assistant</div>
